...
- Mỗi source_id chỉ được xuất hiện một lần trong `citations`; nhiều claims có thể cùng tham chiếu citation_id đó. Nếu cần nhiều chi tiết từ một slide, dùng một snippet nguyên văn đủ đầy thay vì tạo citation trùng ID.
