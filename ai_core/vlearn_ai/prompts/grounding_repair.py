...
GROUNDING_REPAIR_PROMPT_VERSION = "2.2.0"
...
Giữ ý nghĩa ngắn gọn ban đầu nếu có thể chứng minh; xóa mọi câu sự thật không có bằng chứng. Nếu ý định không thể được hỗ trợ, trả về answerability="insufficient_context", claims=[], citations=[]. Không chuyển sang kiến thức nền ngoài bài học trong luồng sửa grounding.
